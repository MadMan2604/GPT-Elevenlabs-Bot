...
def generate_response(user_message):
    ...
    if 'hello' in user_message:
        print('Hello, I am a Virtual Assistant, how may I assist you?')
        return(f'Assistant'[user_message])
    if 'name' in user_message:
        print('I am a Virtual Assistant, but you can call me whatever you like.')
        return(f'Assistant'[user_message])
    if 'goodbye' in user_message:
        print('Ok, have a nice day, Goodbye.')
        return(f'Assistant'[user_message])
...
def run_gui():
    ...
    while True:
        ...
        # Draw button
        button_2 = pygame.rect.Rect(WIDTH, HEIGHT)
        button_2.fill(255, 255, 255)
